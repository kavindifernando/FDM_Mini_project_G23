...
#     <style> 
#         .main { 
#             background-image: url("https://www.spectruminternational.in/wp-content/uploads/2016/03/slide3.jpg"); 
...
def main():
    ...
    if page == "Association":
        ...
        with data_set:
            ...
            # original_title = '<h6 style="font-family:Courier; color:White; font-size:40px;, float:left;">Food Corner Super Market</h6>'
            # st.markdown(original_title, unsafe_allow_html=True)
            # st.image('telecomLogo.jpg', width=120, style="float:right;")
            st.markdown(
            """
                <style> 
                    .main { 
    ...
    #Classification using Logistic Regression 
        ...
        #add_selectbox = st.sidebar.selectbox("Choose the Prediction Method?: ", ['Online', 'Batch'])
        ...
        #background-image: url("https://www.stratospherenetworks.com/blog/wp-content/uploads/2020/04/abstract-computing-network-concept.jpg");
        st.markdown(
            """
                <style> 
                    .main { 
        ...
        if st.button('Predict'):
            ...
            #status = '<h6 style="font-family:Calibri, serif; color:red; font-size:30px; text-align:left; font-weight:bold;"> The Telco Service is {} </h6>'

            #st.write(status.format(result), unsafe_allow_html=True)
